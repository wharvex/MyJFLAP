...
public class SaveGraphUtility {
  ...
  public static void saveGraph(Component apane, JComponent c,
    ...
    Image canvasimage =
        apane.createImage(apane.getWidth(), apane.getHeight());
    ...
    FileFilter spec =
        new FileNameExtensionFilter(description, format.split(","));
    ...
    while (result == JFileChooser.APPROVE_OPTION) {
      ...
      if (!new FileNameExtensionFilter(description,
          format.split(",")).accept(
          file)) //only append if the chosen name is not acceptable
