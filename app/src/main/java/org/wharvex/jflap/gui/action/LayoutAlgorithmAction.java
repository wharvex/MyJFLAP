...
public class LayoutAlgorithmAction extends AutomatonAction {
   ...
   */
  public LayoutAlgorithmAction(String s, Automaton a, Environment e,
                               int algm) {
    super(s, null);
    automaton = a;
    environment = e;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    AutomatonGraph graph =
        LayoutAlgorithmFactory.getAutomatonGraph(algorithm, automaton);
    LayoutAlgorithm layout =
        LayoutAlgorithmFactory.getLayoutAlgorithm(algorithm,
            new Dimension((int) environment.getSize().getWidth() -
                (int) assumedUsedSpace.getWidth(),
