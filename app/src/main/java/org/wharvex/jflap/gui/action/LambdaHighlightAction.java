...
public class LambdaHighlightAction extends AutomatonAction {
  public LambdaHighlightAction(Automaton automaton,
    ...
    super(
        "Highlight " + Universe.curProfile.getEmptyString() + "-Transitions",
        null);
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    environment.add(pane,
        Universe.curProfile.getEmptyString() + "-Transitions",
        new CriticalTag() {
        });
  ...
  private class LambdaPane extends JPanel {
    public LambdaPane(AutomatonPane ap) {
      ...
      add(new JLabel(Universe.curProfile.getEmptyString() +
