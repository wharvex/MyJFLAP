...
public class MultipleCYKSimulateAction extends MultipleSimulateAction {
  ...
  public MultipleCYKSimulateAction(Grammar original, Grammar cnf,
  ...
  public void performAction(Component source) {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (getObject() instanceof Grammar) {
          ...
          CYKParsePane parsePane =
              new CYKParsePane((GrammarEnvironment) getEnvironment(),
    ...
    if (finObject instanceof Grammar) {
      CYKParsePane bp =
          new CYKParsePane((GrammarEnvironment) getEnvironment(),
              (Grammar) finObject, myCNFGrammar,
  ...
  protected void updateView(String machineFileName, String input,
    ...
    if (current instanceof Grammar &&
      ...
      CYKParsePane bp =
          new CYKParsePane((GrammarEnvironment) getEnvironment(), cur,
              myCNFGrammar, null);
      int column = 1;
      if (spot == -1) column = 0;
