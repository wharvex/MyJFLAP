...
import org.wharvex.jflap.gui.grammar.parse.TMBruteParsePane;
...
//		FrameFactory.createFrame(g_trimed);
    ...
    if (g == null)
      return;
    TMBruteParsePane bpp =
        new TMBruteParsePane(environment, g, g_trimmed, myVariableMap, null);
    environment.add(bpp, "Parser for Converted Grammar from TM",
        new CriticalTag() {
        });
