    ...
    if (type.equals(RegPumpingLemmaTransducer.TYPE)) {
      if (name.equals(new ABnAk().getTitle()))
        ...
        return new AnBlAk();
          ...
          new org.wharvex.jflap.pumping.reg.AnBn().getTitle()))
        return new org.wharvex.jflap.pumping.reg.AnBn();
      ...
      if (name.equals(new AnBjAnBj().getTitle()))
        ...
        return new AiBjCk();
          ...
          new org.wharvex.jflap.pumping.cf.AnBn().getTitle()))
        return new org.wharvex.jflap.pumping.cf.AnBn();
